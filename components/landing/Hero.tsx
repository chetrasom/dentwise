                        ...
                        <div className="space-y-10">
                            <div className="space-y-6">
                                ...
                                >
                                    ...
                                    <span className="text-sm font-medium text-primary">AI-Powered Dental Assistant 2026</span>
                                </Badge>
                                ...
                                <div className="flex flex-col gap-6 items-center sm:flex-row">
                                    ...
                                    <div className="space-y-1"> 
                                        ...
                                        <p className="text-sm text-muted-foreground">
                                            Trusted by {" "}
                                            <span className="lining-nums font-semibold text-foreground">2026+ patients</span>
                                        </p>
                                    </div>
                                </div>
                            </div>
